 ...
 */ function InnerLayoutRouter(param) {
    let { tree, segmentPath, debugNameContext, cacheNode: maybeCacheNode, params, url, isActive } = param;
    const context = (0, _react.useContext)(_approutercontextsharedruntime.GlobalLayoutRouterContext);
...
function createServerParamsForRoute(underlyingParams) {
    let varyParamsAccumulator = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
    const workStore = _workasyncstorageexternal.workAsyncStorage.getStore();
    if (!workStore) {
        throw Object.defineProperty(new _invarianterror.InvariantError('Expected workStore to be initialized'), "__NEXT_ERROR_CODE", {
            value: "E1068",
